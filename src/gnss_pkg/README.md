...
To activate the ublox node, run the following command in the terminal: `ros2 launch ublox_gps ublox_f9p_launch.py`, `ros2 launch ublox_gps ublox_f9r_launch.py`
